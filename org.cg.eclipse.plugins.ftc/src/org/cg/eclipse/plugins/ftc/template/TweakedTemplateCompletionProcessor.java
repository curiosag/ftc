 ...
 * @since 3.0
 */
public abstract class TweakedTemplateCompletionProcessor implements IContentAssistProcessor {

	private static final class ProposalComparator implements Comparator {
		public int compare(Object o1, Object o2) {
			return ((TweakedTemplateProposal) o2).getRelevance() - ((TweakedTemplateProposal) o1).getRelevance();
		}
	}
	...
	protected ICompletionProposal createProposal(Template template, TemplateContext context, IRegion region, int relevance) {
		return new TweakedTemplateProposal(template, context, region, getImage(template), relevance);
	}
