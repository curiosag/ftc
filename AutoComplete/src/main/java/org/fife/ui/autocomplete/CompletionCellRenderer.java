...
public class CompletionCellRenderer extends DefaultListCellRenderer {
	...
	/**
	 * Constructor. This is primarily a hook for Substance, or any other Look
	 * and Feel whose renderers look drastically different than standard
	 ...
	 *
	 * @throws Exception
	 *             If Substance is not on the classpath, or some other error
	 ...
	 *
	 * @param font
	 *            The font to use. If this is <code>null</code>, then the
