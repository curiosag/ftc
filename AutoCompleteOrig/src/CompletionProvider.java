...
public interface CompletionProvider {
	 ...
	 *         <code>""</code>) means auto-completion should still be considered
	 *         (i.e., all possible choices are valid).
	 */
	 ...
	 * provider should check the text at the current caret position of the text
	 * component, and decide whether auto-activation would be appropriate here.
	 * For example, a <code>CompletionProvider</code> for Java might want to
	 ...
	 * @param separator
	 *            Text that should separate parameters in a parameter list when
	 *            one is inserted. For example, "<tt>, </tt>".
	 * @param listEnd
	 *            The character that marks the end of a list of parameters, such
	 *            as '<tt>)</tt>' in C or Java.
	 * @throws IllegalArgumentException
	 *             If either <tt>listStart</tt> or <tt>listEnd</tt> is not
	 *             printable ASCII, or if <tt>separator</tt> is
