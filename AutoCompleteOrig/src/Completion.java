...
public interface Completion extends Comparable<Completion> {
	...
	/**
	 * Returns the portion of this completion that has already been entered into
	 * the text component. The match is case-insensitive.
	 * <p>
	 *
	 ...
	 * {@link #getReplacementText()}, but not always (a completion could be a
	 * way to implement shorthand, for example, "<code>sysout</code>" mapping to
