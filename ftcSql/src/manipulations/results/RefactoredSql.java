...
public class RefactoredSql extends ParseResult {
	...
	public RefactoredSql(List<String> tableIds, String original, String refactored, int kWhereStartIndex, String problemsEncountered) {
		super(problemsEncountered);

		this.tableIds = tableIds;
		this.original = original;
		this.refactored = refactored;
		this.keywordWhereStartIndex = kWhereStartIndex;
	}
